...
Refresh procedure:
    ...
    python3 modules/ngx_http_waf/tools/regen-ja4-list.py \
        /tmp/ja4_fingerprint.csv /tmp/ja4plus-mapping.csv \
        modules/ngx_http_waf/lists/ja4.list

Conflict resolution: a JA4 seen with >1 distinct family (or 0 recognizable
ones) is OMITTED -> absent at lookup == WAF_TLSFAM_UNKNOWN, so an ambiguous
...
HEADER = """\
# ngx_http_waf_module - JA4 fingerprint -> coarse TLS-family table
#
